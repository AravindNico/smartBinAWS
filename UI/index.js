...
var currentlySubscribedTopic = 'test/topic';
...
window.customIcons = function(topic,payload){
    ...
    function markerColorMapping(icons){
        if(parseInt(dataPayload.binid) == 1){
        ...
        else if(parseInt(dataPayload.binid) == 2){
            var marker = new google.maps.Marker({
        ...
        else if(parseInt(dataPayload.binid) == 3){
            var marker = new google.maps.Marker({
        ...
        else if(parseInt(dataPayload.binid) == 4){
            var marker = new google.maps.Marker({
        ...
        else if(parseInt(dataPayload.binid) == 5){
            var marker = new google.maps.Marker({
...
function calculateAndDisplayRoute(map,directionsService, directionsDisplay) {
    ...
    //             if(data.Items[0].binlevel > 50){
    //                 var loc = data.Items[0].binlocation
    //                 latlong = loc.split(",",2);
    //                 console.log(latlong)
    //                 // var l = {lat:parseFloat(latlong[0]),lon:parseFloat(latlong[1])}
